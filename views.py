...
def validateDOB(DOB):
    ...
    #newDOB =newDOB[0] + '-' + newDOB[1] + '-' + newDOB[2]
    #print newDOB
    strDOB= str(DOB)
    print strDOB
    newDOB= strDOB.split('-')
    ...
    #get_program_hours = DOB.strftime('%Y')
    #print get_program_hours
    if (newDOB[0] < '1900'):
...
class AddReviewAPI(MethodView):
    ...
    def post(self, id):
        ...
        if form.title.validate(form) and form.body.validate(form):
            ...
            print("The form rating is :" + str(form.rating.data))
